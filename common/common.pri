...
CONFIG += c++11 no_keywords x11extras debug link_pkgconfig xrandr
CONFIG -= app_bundle
...
PKGCONFIG += glib-2.0  gio-2.0 libxklavier x11 xrandr xtst atk gdk-3.0 gtk+-3.0 xi kysdk-sysinfo kysdk-hardware gudev-1.0

QMAKE_CXXFLAGS +=  -Wno-unused-parameter
SOURCES += \
        $$PWD/UsdDictionary.cpp \
        $$PWD/clib-syslog.c             \
