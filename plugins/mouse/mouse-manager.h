...
public:
    ...
    void SetMotionAll (bool touchpad);
    void SetMotion   (XDeviceInfo  *device_info , bool touchpad);
    void SetMotionLibinput (XDeviceInfo  *device_info , bool touchpad);
    ...
    void SetNaturalScrollAll (bool isTouchPad = true);
    void setNaturalScroll (XDeviceInfo *device_info,bool isTouchPad);
    void setNaturalScrollSynaptics (XDeviceInfo *device_info,bool isTouchpad);
    void setNaturalScrollLibinput (XDeviceInfo *device_info,bool isTouchPad);

    void SetDevicepresenceHandler ();
    void SetMouseWheelSpeedAll();
    void SetMouseWheelSpeed(XDeviceInfo *device_info);
    void SetMouseWheelSpeedByLibinput(XDeviceInfo* device_info);
    void SetMouseWheelSpeedByImwheel(int speed);
