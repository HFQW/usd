...
{
public:
    static bool readInOutputs(KScreen::ConfigPtr config,
...
private:
    ...
    static bool readIn(KScreen::OutputPtr output, const QVariantMap &info);
    static bool readInGlobal(KScreen::OutputPtr output);
    static bool readInGlobalPartFromInfo(KScreen::OutputPtr output, const QVariantMap &info);
    /*
